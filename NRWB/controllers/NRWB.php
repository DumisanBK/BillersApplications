...
class NRWB extends MX_Controller {
    ...
    public function __construct() {
        ...
        //load models
        $this->load->model('NRWBPayments');

        //load helpers 
        $this->load->helper('nrwb_helper');
    }
    ...
    public function searchMeterNo() {
        ...
        $login_result = nrwb_login();

        $data_out = nrwb_get_customer_details($meter_no);
    ...
    public function calculateCustomerFee() {
        ...
        $data_out = nrwb_calculate_customer_fee($meter_no, $amount);
    ...
    public function purchaseToken() {
        ...
        $gatePass = "Default";
        $decrypted_password = $this->NRWBPayments->getPassword();
        ...
        $formData = array('TellerId' => $tellerID, 'TellerName' => $tellerName,
            ...
            'GatePass' => $gatePass, 'AppPass' => $appKey, 'AppName' => "NRWB",
            'DecryptedPassword' => $decrypted_password
        );

        $data = nrwb_request_token($formData);
